...
import com.machadocrypto.kobocoinj.core.ScriptException;
import com.machadocrypto.kobocoinj.core.Transaction;
import com.machadocrypto.kobocoinj.core.Transaction.Purpose;
...
import com.machadocrypto.kobocoinj.utils.Threading;
...
import com.machadocrypto.kobocoin_android_wallet.util.ThrottlingWalletChangeListener;
...
public class TransactionsListFragment extends SherlockListFragment implements LoaderCallbacks<List<Transaction>>, OnSharedPreferenceChangeListener
{
	...
	{
		if (Configuration.PREFS_KEY_KOBO_PRECISION.equals(key))
			updateView();
	}
	...
	private void updateView()
	{
		...
		adapter.setPrecision(KOBOPrecision, KOBOShift);
		adapter.clearLabelCache();
	}
}
