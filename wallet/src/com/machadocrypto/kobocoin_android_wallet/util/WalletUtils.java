...
package com.machadocrypto.kobocoin_android_wallet.util;
...
import com.machadocrypto.kobocoinj.core.DumpedPrivateKey;
...
import com.machadocrypto.kobocoinj.core.TransactionInput;
import com.machadocrypto.kobocoinj.core.TransactionOutput;
import com.machadocrypto.kobocoinj.core.Wallet;
import com.machadocrypto.kobocoinj.script.Script;
import com.machadocrypto.kobocoinj.store.WalletProtobufSerializer;
...
public class WalletUtils
{
	...
	public static BigInteger localValue(@Nonnull final BigInteger KOBOValue, @Nonnull final BigInteger rate)
	{
		return KOBOValue.multiply(rate).divide(GenericUtils.ONE_KOBO);
	}

	public static BigInteger KOBOValue(@Nonnull final BigInteger localValue, @Nonnull final BigInteger rate)
	{
		return localValue.multiply(GenericUtils.ONE_KOBO).divide(rate);
	}
