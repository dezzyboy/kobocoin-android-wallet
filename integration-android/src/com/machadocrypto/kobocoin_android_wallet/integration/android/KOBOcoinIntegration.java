...
package com.machadocrypto.kobocoin_android_wallet.integration.android;
...
public final class KOBOcoinIntegration
{
	...
	private static void redirectToDownload(final Context context)
	{
		...
		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.machadocrypto.kobocoin_android_wallet"));
		final Intent binaryIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/machado-rev/kobocoin-android-wallet"));
